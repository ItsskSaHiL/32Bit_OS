FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/memory/memory.o ./build/idt/idt.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o ./build/fs/pparser.o ./build/fs/fat.o ./build/string/string.o ./build/disk/streamer.o ./build/fs/file.o
INCLUDES = -I./src
...
directories:
	mkdir -p ./build/idt ./build/memory/heap ./build/memory/paging ./build/io ./build/disk ./build/fs ./build/string ./bin
...
define create_disk_image
	# Create a 17MB disk image with boot and kernel
	dd if=/dev/zero of=./bin/os.bin bs=1M count=17
	# Copy boot sector
	dd if=./bin/boot.bin of=./bin/os.bin bs=512 count=1 conv=notrunc
	# Copy kernel (skip to sector 2048)
	dd if=./bin/kernel.bin of=./bin/os.bin bs=512 seek=2048 conv=notrunc
endef
...
./build/fs/fat.o: ./src/fs/fat.c
	i686-elf-gcc $(INCLUDES) -I./src/fs $(FLAGS) -std=gnu99 -c ./src/fs/fat.c -o ./build/fs/fat.o
